...
module A2AMatchers
  ...
  RSpec::Matchers.define :be_valid_agent_card do
    match do |actual|
      ...
      # Required fields
      required_fields = %w[name description version url preferredTransport skills capabilities defaultInputModes defaultOutputModes]
  ...
  RSpec::Matchers.define :have_a2a_error do |expected_code|
    match do |actual|
      ...
      return false unless (-32010..-32001).include?(expected_code)
  ...
  RSpec::Matchers.define :be_valid_push_notification_config do
    match do |actual|
      ...
      if actual.key?('id')
        return false unless actual['id'].is_a?(String)
      end
