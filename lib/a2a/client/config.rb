  ...
  module Client
    ...
    class Config
      ...
      def initialize(streaming: true, polling: false, supported_transports: nil,
        ...
        @accepted_output_modes = accepted_output_modes || ['text', 'file', 'data']
      ...
      def validate!
        ...
        raise ArgumentError, "retry_attempts must be non-negative" if @retry_attempts < 0
        ...
        @supported_transports.each do |transport|
          unless A2A::Types::VALID_TRANSPORTS.include?(transport)
