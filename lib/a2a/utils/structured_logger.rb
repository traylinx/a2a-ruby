...
module A2A
  module Utils
    ...
    class StructuredLogger
      ...
      attr_reader :logger, :correlation_id, :service_name, :version
      ...
      def initialize(output: $stdout, level: :info, service_name: 'a2a-ruby', version: A2A::VERSION, correlation_id: nil)
