  ...
  module Utils
    ...
    class MessageBuffer
      ...
      def write(data)
        ...
        if @compress && @total_size > COMPRESSION_THRESHOLD && !@compressed
          compress!
        end
      ...
      def compression_ratio
        return 0.0 unless @compressed && @original_size && @original_size > 0
      ...
      def optimize!
        ...
        if @buffer.string.respond_to?(:squeeze!)
      ...
      def ensure_capacity(capacity)
        ...
        @buffer.write("\0" * padding_needed) if padding_needed > 0
