  ...
  module Server
    module Middleware
      ...
      class CorsMiddleware
        ...
        def initialize(origins: '*', methods: ['POST', 'OPTIONS'], 
                       headers: ['Content-Type', 'Authorization'], 
                       credentials: false, max_age: 86400, expose_headers: [])
        ...
        def call(request, context)
          ...
          if http_method.upcase == 'OPTIONS'
            return handle_preflight(origin, context)
          end
