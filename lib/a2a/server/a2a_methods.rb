...
module A2A
  module Server
    ...
    module A2AMethods
      ...
      def handle_tasks_get(params, context)
      ...
      def handle_tasks_cancel(params, context)
        validate_required_params(params, %w[id])
      ...
      def handle_tasks_resubscribe(params, context)
        validate_required_params(params, %w[id])
      ...
      def handle_push_notification_config_set(params, context)
      ...
      def handle_push_notification_config_get(params, context)
        ...
        if config
          ...
          raise A2A::Errors::NotFound.new("Push notification config not found")
        end
      end
      ...
      def handle_push_notification_config_list(params, context)
        validate_required_params(params, %w[taskId])
      ...
      def handle_push_notification_config_delete(params, context)
      ...
      def handle_agent_get_card(params, context)
      ...
      def handle_agent_get_authenticated_extended_card(params, context)
      ...
      def validate_required_params(params, required)
        missing = required.select { |param| !params.key?(param) }
        
        unless missing.empty?
          raise A2A::Errors::InvalidParams.new(
