    ...
    class Engine < ::Rails::Engine
      ...
      initializer "a2a.middleware", after: "a2a.configuration" do |app|
        if app.config.a2a.enabled && app.config.a2a.middleware_enabled
          ...
          if app.config.a2a.authentication_required
            app.middleware.use A2A::Server::Middleware::AuthenticationMiddleware
          end

          # Add rate limiting middleware if enabled
          if app.config.a2a.rate_limiting_enabled
            app.middleware.use A2A::Server::Middleware::RateLimitMiddleware
          end

          # Add logging middleware if enabled
          if app.config.a2a.logging_enabled
            app.middleware.use A2A::Server::Middleware::LoggingMiddleware
          end
        end
      end
      ...
      initializer "a2a.rails_compatibility" do |app|
        ...
        if ::Rails.version >= "6.0"
          ...
          config.eager_load_paths << File.expand_path("../../", __FILE__) if ::Rails.env.production?
        end
      ...
      # Rake tasks
      rake_tasks do
        load File.expand_path("../tasks/a2a.rake", __FILE__)
      end
      ...
      def self.validate_configuration!(app)
        ...
        if app.config.a2a.enabled && !app.config.a2a.mount_path.start_with?("/")
          raise A2A::Errors::ConfigurationError, 
